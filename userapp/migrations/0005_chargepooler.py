...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.CreateModel(
            name='ChargePooler',
            fields=[
                ('consumer', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, primary_key=True, serialize=False, to='userapp.Consumer')),
                ('city', models.CharField(default=userapp.models.city, max_length=25)),
                ('local_area', models.CharField(default=userapp.models.sub, max_length=25)),
                ('ph_no', models.CharField(default=userapp.models.phone, max_length=13)),

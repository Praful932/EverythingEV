...
alpr = Alpr(
    "in",
    "/home/praful/openalpr/src/build/config/openalpr.conf",
    "/home/praful/openalpr/runtime_data",
)
...
def get_vehicle_details(lic_plate):
    ...
    with requests.Session() as s:
        ...
        table_body = s.post(
            "https://vahaninfos.com/getdetails.php", headers=headers, data=data
        )
                ...
                if candidate["matches_template"]:
                    ...
                    if car_model:
                        ...
                        return [
                            candidate["plate"],
                            car_model,
                            city + "00" + str(random.randint(1, 3)),
                            city,
                            str(start_time),
                            str(stop_time),
                            str(duration),
